    ...
    <div className="grid grid-cols-1 lg:grid-cols-2">
        <div className="flex items-center justify-center px-4 py-2 bg-white sm:px-6 lg:px-8">
            <div className="xl:w-full xl:max-w-sm 2xl:max-w-md xl:mx-auto">
                ...
                <p className="mt-2 text-[14px] text-gray-600">Don’t have an account? <a href="#" title="" className="font-medium text-blue-600 transition-all duration-200 hover:text-blue-700 hover:underline focus:text-blue-700">Create a free account</a></p>
                    ...
                    <div className="space-y-5">
                        ...
                        <div>
                            <div className="flex items-center justify-between">
                                <label for="" className="text-[14px] font-medium text-gray-900"> Password </label>
